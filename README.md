...
**Demo video (non-technical overview):**  
*/videos/nontechnical_presentation.mp4

**Technical walkthrough (code + ML details):**  
*/videos/technical_walkthrough.mp4

## Individual Contributions
This was a solo project. All data processing, model implementation, evaluation, analysis, and documentation was done by me.
